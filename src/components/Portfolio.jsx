...
const CATEGORIES = ['All', 'Dashboard', 'E-commerce', 'Landing Page', 'App'];
  ...
  return (
    <section id="portfolio" className="section-padding bg-zinc-900/30">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            <h2 className="text-sm uppercase tracking-widest text-primary-500 font-bold mb-4">Portfolio</h2>
            <h3 className="text-4xl lg:text-6xl font-display font-bold">Featured <span className="text-white">Works</span></h3>
          </div>
                ...
                <div className="mt-8 space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag, t) => (
                      <span key={t} className="text-[10px] uppercase tracking-wider font-bold text-primary-400 bg-primary-400/10 px-3 py-1 rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
                  <h4 className="text-2xl font-bold text-white group-hover:text-primary-400 transition-colors">{project.title}</h4>
