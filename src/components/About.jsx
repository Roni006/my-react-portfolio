  ...
  return (
    <section id="about" className="section-padding max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="mb-8">
            <h2 className="text-sm uppercase tracking-widest text-primary-500 font-bold mb-3">
              About
            </h2>
            <h3 className="text-4xl lg:text-5xl font-display font-bold leading-tight">
              Building <span className="text-white">superior digital</span>{" "}
              products.
            </h3>
          </div>
          ...
          <div className="space-y-6 text-zinc-400 text-lg leading-relaxed">
            <p>
              Over 5 years of industry experience crafting responsive,
              user-friendly websites. I focus on clean, scalable code and
              polished user interfaces.
            </p>
            <p>
              I believe great software lives at the intersection of robust
        ...
        >
          ...
          <div className="col-span-2 glass-card p-8 bg-zinc-900/40 border-white/5 relative overflow-hidden group">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-white font-semibold text-sm hover:border-primary-500/30 transition-all">
                <p>React.js</p>
              </div>
          ...
          <div className="glass-card p-6 bg-primary-600/5 border-primary-500/10 flex flex-col justify-between">
            <h4 className="text-[10px] font-bold uppercase tracking-widest text-primary-400 mb-4">
              Workflow
            </h4>
            <div className="space-y-3">
          ...
          <div className="col-span-2 glass-card p-6 bg-zinc-950/50 border-white/5">
            <p className="text-sm text-zinc-400 leading-relaxed italic">
              "Continuous learning is my core philosophy. Currently diving into
              WebGL and high-performance rendering."
            </p>
          </div>
